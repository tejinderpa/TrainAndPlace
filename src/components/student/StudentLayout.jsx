  ...
  const navItems = [
    {
      ...
      items: [
        ...
        { path: "/student/tpo", icon: GraduationCap, label: "TPO" },
        { path: "/student/companies", icon: Building2, label: "Companies" },
    ...
    },
    {
      category: "Resources",
      items: [
        { path: "/student/learning", icon: BookOpen, label: "Learning Hub" },
    ...
    },
    {
      category: "Community",
      items: [
        { path: "/student/community", icon: Users, label: "Forum" },
